class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/staffwiki$ https://www.ocf.berkeley.edu/docs/staff/ [R]'},
      {rewrite_rule => '^/staff-wiki$ https://ocf.io/staffwiki [R]'},
      {rewrite_rule => '^/staff_wiki$ https://ocf.io/staffwiki [R]'},
